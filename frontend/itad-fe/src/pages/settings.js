...
const Settings = () => {
    ...
    async function getSettings(){
        try{
            ...
            await fetch('http://api.onetakeaday.com/settings/' + id, {
                credentials: "include"
            })
            .then((res) => res.json())
            .then((json) => {
    ...
    async function handleDisplayName(){
        try{
            ...
            await fetch('http://api.onetakeaday.com/settings/display', {
                method: "PUT",
                body: JSON.stringify({
                    id: id,
    ...
    async function handleCompleteBtn(){
        try{
            ...
            await fetch('http://api.onetakeaday.com/settings/bio', {
                method: "PUT",
                body: JSON.stringify({
                    id: id,
                    bio: bio
