...
const PostPage = () => {
    ...
    async function getComments(){
        try{
            ...
            await fetch(('http://api.onetakeaday.com/comment/' + id + '/' + user_id), {
              credentials: "include"
            })
            .then((res) => res.json())
            .then((json) => {
    ...
    function formatDate(uDate){
      ...
      async function delLike(){
        try{
          ...
          await fetch("http://api.onetakeaday.com/like", {
            method: "DELETE",
            body: JSON.stringify({
              post_id: id,
              user_id: user_id
      ...
      async function delPost(){
        try{
          const refresh = await refreshUserToken(user_id)
            ...
            await fetch('http://api.onetakeaday.com/post', {
              method: "DELETE",
              body: JSON.stringify({
                post_id: id
              }),
      ...
      async function addComment(){
        try{
            ...
            await fetch('http://api.onetakeaday.com/comment', {
                method: "POST",
                body: JSON.stringify({
                    post_id: id,
                    user_id: user_id,
